...
<%}
            ...
            System.out.println(e);
             ...
             %>
                ...
                ResultSet rs=st.executeQuery("select *  from f15csetotaldb order by percent desc limit 3");
                while(rs.next()){
