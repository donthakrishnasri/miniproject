...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
     <h1 align ="center" >MAHAVEER INSTITUTE OF SCIENCE AND TECHNOLOGY</h1>
      <h1 align ="center" >Reset Password Page</h1>
      ...
      <script type="text/javascript">
            function validate()
            {
                var a=document.reg.pass.value;
                 var b=document.reg.cpass.value;
                if(a!==b){
...
<form name ="reg" action="stupasswordchange.jsp" method="post"  onsubmit="return validate()">
  <div class="imgcontainer">
    <img src="img_avatar2.png" alt="Avatar" class="avatar">
  </div>

  <div class="container">
      <field name="pass" style="color:black;" attrs="{'readonly':[('state', '=', 'done')]}"/>          
    <input type="password" placeholder="Enter Password" name="pass" required>

        <field name="cpass" style="color: black;" attrs="{'readonly':[('state', '=', 'done')]}"/>
  ...
  <div class="container" style="background-color:#f1f1f1">
      <span class="sss"> <a href="student.html">Login</a></span>
