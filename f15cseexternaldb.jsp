...
<%
    ...
    try{
          ...
          for(int i=0;i<srno.length;i++){
              ...
              String sql = "insert into f15cseexternaldb values('"+srno[i]+"','"+rollno[i]+"','"+sub1[i]+"','"+sub2[i]+"','"+sub3[i]+"','"+sub4[i]+"','"+sub5[i]+"','"+sub6[i]+"','"+lab1[i]+"','"+lab2[i]+"')";
...
" from f15cseinternal1_db f1,f15cseinternal2_db f2 where f1.rollno=f2.rollno");
          
          while(rs1.next()){ 
               Statement st2= con.createStatement();
         
       String sql="insert into f15cseavgdb  values('"+rs1.getString(1)+"','"+rs1.getString(2)+"','"+rs1.getString(3)+"','"+rs1.getString(4)+"','"+rs1.getString(5)+"','"+rs1.getString(6)+"','"+rs1.getString(7)+"','"+rs1.getString(8)+"','"+rs1.getString(9)+"')";
...
" from f15cseavgdb f1,f15cseexternaldb f2 where f1.rollno=f2.rollno");
          
          while(rs2.next()){ 
               Statement st3= con.createStatement();
         
       String sql1="insert into f15csetotaldb  values('"+rs2.getString(1)+"','"+rs2.getString(2)+"','"+rs2.getString(3)+"','"+rs2.getString(4)+"','"+rs2.getString(5)+"','"+rs2.getString(6)+"','"+rs2.getString(7)+"','"+rs2.getString(8)+"','"+rs2.getString(9)+"','"+rs2.getString(10)+"','"+rs2.getString(11)+"')";
