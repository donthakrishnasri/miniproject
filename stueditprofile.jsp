...
<div class="wrapper row2">
  <nav id="mainav" class="hoc clear"> 
    ...
    <div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/moon.jpg');">
  <div id="pageintro" class="hoc clear"> 
    ...
    <article>
         ...
         ResultSet rs = st.executeQuery("select  * from student where userid ='"+userid+"' ");
          ...
          {
              %>
              <form name ="reg" action="steditdb.jsp" method="post"  onsubmit="return validate()"/>
