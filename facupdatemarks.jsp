  ...
  <nav id="mainav" class="hoc clear"> 
    ...
    <ul class="clear">
      <li class="active"><a href="facultyhome.jsp">Home</a></li>
       <li><a class="btn" href="facupdateprofile.jsp">Update profile</a></li>
       <li><a class="btn" href="marks.jsp">Update marks</a></li>
        <li><a class="btn" href="facupdateattendance.jsp">Update attendance</a></li>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/b.jpg');">
