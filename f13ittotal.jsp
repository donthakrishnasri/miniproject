...
@media screen and (max-width: 300px) {
  ...
  <nav id="mainav" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <ul class="clear">
      <li class="active"><a href="fr13.jsp">Home</a></li>
...
<%}
            ...
            System.out.println(e);
             ...
             %>
                ...
                ResultSet rs=st.executeQuery("select *  from totaldb order by percent desc limit 3");
                while(rs.next()){
