<%-- 
    Document   : otp
    Created on : Jun 12, 2018, 2:14:26 PM
    Author     : windows
--%>
...
<form name ="reg" action="stuotpverify.jsp" method="post"  onsubmit="return validate()">
  <div class="imgcontainer">
    <img src="img_avatar2.png" alt="Avatar" class="avatar">
  </div>

  <div class="container">
      <field name="otp" style="color:black;" attrs="{'readonly':[('state', '=', 'done')]}"/>          
...
<script src="layout/scripts/jquery.mobilemenu.js"></script>
        ...
        <center><h1>ENTER OTP TO RESET PASSWORD</h1></center>
        <table align="center">
            <form name="reg" action="stuotpverify.jsp" method="post" onsubmit="return validate()">
                <tr>
                    <td>ENTER OTP</td>
                    <td><input type="text" name="otp"  required></td></tr>
                 <td></td>
                    <td><input type="submit" value="verify"  required></td></tr>
             <td></td>
             <td><a href="login.jsp">login here</a></td></tr>
            </form>
        </table>
    </body>
</html>
